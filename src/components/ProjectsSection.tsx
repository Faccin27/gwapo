    ...
    <Card ref={cardRef} className="overflow-hidden group cursor-pointer border-none shadow-lg">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
          <span className="text-gwapo font-medium text-sm mb-2">{category}</span>
    ...
    <section id="projects" ref={sectionRef} className="py-20">
      <div className="container mx-auto px-4">
        <div ref={headerRef} className="text-center mb-16">
          <h6 className="text-gwapo font-medium mb-2">{t('projects-title')} </h6>
        ...
        <div className="text-center mt-12">
          <Button variant="outline" className="border-gwapo text-gwapo hover:bg-gwapo/10 px-8 py-6 text-lg">
          {t('view-all-projects')} 
          </Button>
        </div>
      </div>
